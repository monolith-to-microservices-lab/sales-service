"""OpenTelemetry bootstrap for the sales-service-cdc consumer process.

Best-effort: if the otel packages aren't installed or the collector is
unreachable, this silently no-ops - it never blocks startup or breaks a
message being processed. Mirrors user-service's app/tracing.py.
"""
...
logger = logging.getLogger("sales.tracing")
